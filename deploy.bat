...
ssh -i C:\Users\Harry\.ssh\jackypc -p 25510 mcg@home.jackyliao.me "cd /home/mcg/Servers; cp MinecraftGamesServer.jar Lobby/plugins; cp MinecraftGamesServer.jar Spleef/plugins; cp MinecraftGamesServer.jar Dodgeball/plugins"
